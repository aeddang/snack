 ...
 *
 */
var g_FlashVersion_major = "";
var g_FlashVersion_minor = "";
...
deconcept.SWFObject.prototype = {
	...
	getSWFHTML: function() {
		var swfNode = "";
		g_FlashVersion_major = Number(this.installedVer.major);
		g_FlashVersion_minor = Number(this.installedVer.minor);
	    var g_FlashVersion=g_FlashVersion_major+(g_FlashVersion_minor/10)
		
		/*
		if( Number(g_FlashVersion) < 10.2) //imp2joo
	    {
		        if(this.vsAlert==false){
					this.vsAlert=true;
					alert('플래시 버전 10.2 이상에서 실행해주세요.');
					if(jarvis.lib.isMobile()==true){
					   location.href='http://mini.imbc.com/webapp/install_flash_player_ics.apk';
					}else{
						location.href='http://get.adobe.com/kr/flashplayer/';
					    //location.href='http://helpx.adobe.com/flash-player/kb/archived-flash-player-versions.html';
					}
					
					
				//swfNode = "<a href='http://get.adobe.com/kr/flashplayer/' target='_blank'><img src='images/flash_player_notice.jpg' /></a>";
				}
		    return;
        ...
        */
		...
		if (navigator.plugins && navigator.mimeTypes && navigator.mimeTypes.length) { // netscape plugin architecture
			...
			if(pairs.length > 0) {swfNode += '<param name="flashvars" value="'+ pairs +'" />';}
                        ...
                        swfNode += "<a href='http://get.adobe.com/kr/flashplayer/' target='_blank'><img src='https://wwwimages2.adobe.com/downloadcenter/singlepage/live/images/flash_windows.gif' /></a>"
                        swfNode += "</object>";
		}
		return swfNode;
	},
...
{
	// movieid 해당 플래시무비의 높이넓이값을 설정합니다
