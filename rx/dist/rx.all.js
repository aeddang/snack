...
var ObserveOnObservable = (function (__super__) {
  ...
  */
  ...
  /**
   *  Creates an custom observable sequence from a specified subscribe method implementation.
   * @example
   *  var res = Rx.Observable.mecro([Observable,Observable,Observable,...]);
   * @param {Array<Observable>, function(){return Bool}
   * @returns {Observable} The observable sequence with the specified implementation for the Subscribe method.
   */
  Observable.mecro = function (observables,isRepeat) 
  {
    ...
    function setSubject()
    {
      let source = observables[idx];
      //console.log('mecro init: ' + idx);  
      observables[idx].subscribe
      (
        function (value) 
        {
            //console.log('mecro next: ' + value);  
        },
        function (err) 
        {
            console.log('RX Observable.mecro error : ' + err);  
            subject.onError();
        },
        function () 
        {
            //console.log('mecro completed : ' + idx);  
          subject.onNext(idx); 
          idx++;
